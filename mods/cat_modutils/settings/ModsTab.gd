...
var submodule: Reference
var _widgets: Array

func _ready() -> void:
	submodule = DLC.mods_by_id["cat_modutils"].settings

	for mod in submodule._mod_settings:
